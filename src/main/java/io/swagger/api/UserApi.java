...
public interface UserApi  {  //extends MongoRepository <User, String>
    ...
    ResponseEntity<Boolean> createUser(@ApiParam(value = "Created user object" ,required=true )  @Valid @RequestBody User user);
